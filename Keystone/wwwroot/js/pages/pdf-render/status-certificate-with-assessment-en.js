...
var page = {
    ...
    p5 : ["is a bona fide", "student", "in the", "-year", ",", "majoring in", 
          ...
          "I also certify that English is the medium of instruction and",
          "assessment at Mahidol University.",
          "Date of issue :"],
...
function renderCertificate() {
    ...
    report.text(`${ page.p5[0] } ${ dataBody.StudentYear } ${ page.p5[1] }`, centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
          ...
          .text(page.p5[7], centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
