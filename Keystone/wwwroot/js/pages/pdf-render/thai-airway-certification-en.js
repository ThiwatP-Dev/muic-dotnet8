...
var page = {
    ...
    p4 : "Adm. No.",
    p5 : ["has completed the requirements towards a", "majoring in", 
          "from Mahidol University of Thailand.", "Date of issue :"],
...
function renderCertificate() {
    ...
    PdfSettings.format(report, textFormats.serifN)
    report.text(page.p5[0], centerX, currentY += lineYL, PdfSettings.style(textStyles.CertificateCenter))
          .text(`${ dataBody.DegreeName },`, centerX, currentY += defaultSetting.NormalLine, PdfSettings.style(textStyles.CertificateCenter))
          .text(`${ page.p5[1] } ${ dataBody.DepartmentName }`, centerX, currentY += defaultSetting.NormalLine, PdfSettings.style(textStyles.CertificateCenter))
          .text(page.p5[2], centerX, currentY += defaultSetting.NormalLine, PdfSettings.style(textStyles.CertificateCenter))
          .text(`${ page.p5[3] } ${ getDateText(language, issuedDate) }`, centerX, currentY += lineYL, PdfSettings.style(textStyles.CertificateCenter));
