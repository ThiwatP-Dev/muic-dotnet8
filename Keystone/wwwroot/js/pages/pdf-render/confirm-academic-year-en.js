...
var page = {
    ...
    p4 : "Adm. No.",
    p5 : ["is a bona fide", "student", "in the", "-year", ",", "majoring in", 
          "at Mahidol University of Thailand.", 
...
function renderCertificate() {
    ...
    PdfSettings.format(report, textFormats.serifN)
    report.text(`${ page.p5[0] } ${ dataBody.StudentYear } ${ page.p5[1] }`, centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
          .text(`${ page.p5[2] } ${ dataBody.StudyYear }${ page.p5[3] } ${ dataBody.DegreeName }${ page.p5[4] }`,centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
          .text(`${ page.p5[5] } ${ dataBody.DepartmentName }`, centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
          .text(page.p5[6], centerX, currentY += lineYS, PdfSettings.style(textStyles.CertificateCenter))
          .text(page.p5[7], centerX, currentY += lineYL, PdfSettings.style(textStyles.CertificateCenter))
